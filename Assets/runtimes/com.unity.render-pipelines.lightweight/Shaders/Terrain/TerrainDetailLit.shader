Shader "Hidden/TerrainEngine/Details/Vertexlit" 
{
    ...
    SubShader 
    {
        ...
        Pass
        {
            ...
            #include "Assets/runtimes/com.unity.render-pipelines.lightweight/ShaderLibrary/Core.hlsl"
            #include "Assets/runtimes/com.unity.render-pipelines.lightweight/ShaderLibrary/Lighting.hlsl"
        ...
        Pass
        {
            ...
            #include "Assets/runtimes/com.unity.render-pipelines.lightweight/Shaders/UnlitInput.hlsl"
            #include "Assets/runtimes/com.unity.render-pipelines.lightweight/Shaders/DepthOnlyPass.hlsl"
            ENDHLSL
        }
        ...
        Pass
        {
            ...
            #include "Assets/runtimes/com.unity.render-pipelines.lightweight/Shaders/SimpleLitInput.hlsl"
            #include "Assets/runtimes/com.unity.render-pipelines.lightweight/Shaders/SimpleLitMetaPass.hlsl"
